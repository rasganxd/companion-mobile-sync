...
const RouteCard: React.FC<RouteCardProps> = ({
  ...
  return <div key={route.day} onClick={() => onVisitDay(route.day)} className="bg-white rounded-lg shadow-sm p-2 mb-1.5 cursor-pointer hover:bg-gray-50 active:scale-[0.98] transition-all duration-200">
