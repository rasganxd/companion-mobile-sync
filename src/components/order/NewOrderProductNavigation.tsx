      ...
      <div className="flex justify-between items-center text-sm text-gray-600">
        ...
        {categoryInfo && (
          <div className="text-right">
            <div className="font-medium text-blue-600">{categoryInfo.categoryName}</div>
            <div className="text-xs">
              Categoria {categoryInfo.categoryIndex} de {categoryInfo.totalCategories} • 
              Item {categoryInfo.productIndexInCategory} de {categoryInfo.totalProductsInCategory}
            </div>
          </div>
        )}
      </div>
