  ...
  if (clients.length > 0 && salesRep) {
    return <div className="space-y-4">
        ...
        {filteredClients.length > 0 ? <>
            {viewMode === 'paginated' ? <ClientPaginatedView clients={filteredClients} currentPage={currentPage} onPageChange={setCurrentPage} onClientSelect={onClientSelect} onToggleView={toggleViewMode} /> : <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {filteredClients.map(client => <ClientCard key={client.id} client={client} onSelect={onClientSelect} onViewDetails={handleViewDetails} />)}
                </div>
              </div>}
