        ...
        <Card className="mb-4 border-blue-200">
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 gap-3">
              <Button onClick={startFreshEntry} variant="outline" className="w-full border-blue-300 text-blue-600 hover:bg-blue-50">
        ...
        <Card className="mb-4">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input type="url" value={apiUrl} onChange={handleApiUrlChange} placeholder="https://ufvnubabpcyimahbubkd.supabase.co/functions/v1/orders-api" className="w-full" />
              {apiUrl && !isUrl(apiUrl) && <p className="text-xs text-red-500">URL inválida. Deve começar com http:// ou https://</p>}
            </div>
            ...
            <Button onClick={testApiConnection} disabled={isTestingApi || !apiUrl.trim() || !isUrl(apiUrl)} className="w-full" variant="outline">
        ...
        <Card className="mb-4">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input type="text" value={token} onChange={handleTokenChange} placeholder="sk_..." className="w-full" />
              {token && !isValidToken(token) && <p className="text-xs text-red-500">Token deve começar com "sk_" e ter pelo menos 10 caracteres</p>}
            </div>
            ...
            <Button onClick={testToken} disabled={isTestingToken || !token.trim() || !apiUrl.trim() || !isValidToken(token) || !isUrl(apiUrl)} className="w-full" variant="outline">
