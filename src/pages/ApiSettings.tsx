...
const ApiSettings = () => {
  ...
  const testToken = async () => {
    ...
    try {
      console.log('🔑 Testing token against API:', apiUrl);
      
      // Test token with a simple request to the API
  ...
  const saveConfiguration = () => {
    ...
    console.log('💾 API configuration saved:', { apiUrl, tokenLength: token.length });
          ...
          <CardContent className="pt-6">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-gray-600">
                <p className="font-medium mb-1">Configuração da API Externa</p>
                <p>Configure a URL da API do sistema desktop e o token de acesso para sincronizar dados entre o mobile e o sistema principal.</p>
              </div>
            </div>
          </CardContent>
        </Card>
