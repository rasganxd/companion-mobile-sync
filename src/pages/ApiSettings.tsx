        ...
        <Card className="mb-4">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input type="url" value={apiUrl} onChange={e => setApiUrl(e.target.value)} placeholder="https://ufvnubabpcyimahbubkd.supabase.co/functions/v1/orders-api" className="w-full" />
            </div>
