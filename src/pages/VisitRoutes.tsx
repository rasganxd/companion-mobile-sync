  ...
  return <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="p-3 flex-1">
        ...
        <div className="bg-white rounded-xl shadow-sm p-3 mb-3">
            <h2 className="text-base font-semibold mb-2 text-gray-800">Resumo do Dia</h2>
        ...
        {/* Lista de Rotas */}
        <div>
            <h2 className="text-base font-semibold mb-2 text-gray-700">Rotas da Semana</h2>
            {routes.map(route => (
                <div key={route.day} onClick={() => handleVisitDay(route.day)} className="bg-white rounded-xl shadow-sm p-3 mb-2 cursor-pointer hover:bg-gray-50 active:scale-[0.98] transition-all duration-200">
                    <div className="flex items-center mb-2">
                        <CalendarDays className="h-4 w-4 text-gray-500 mr-2" />
                        <h3 className="font-semibold text-base text-gray-800">{route.day}</h3>
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center text-xs">
                            ...
                            <span className="font-semibold text-blue-600 ml-auto">{route.pendentes}</span>
                        </div>
                        <div className="flex items-center text-xs">
                            <CheckCircle2 className="h-4 w-4 text-green-500 mr-2 flex-shrink-0" />
                            <span className="font-medium text-gray-600">Positivados</span>
                            <span className="font-semibold text-green-600 ml-auto">{route.positivados}</span>
                        </div>
                        <div className="flex items-center text-xs">
                            <XCircle className="h-4 w-4 text-red-500 mr-2 flex-shrink-0" />
                            <span className="font-medium text-gray-600">Negativados</span>
                            <span className="font-semibold text-red-600 ml-auto">{route.negativados}</span>
                        </div>
                    </div>
                    {route.totalSales > 0 && (
                        <>
